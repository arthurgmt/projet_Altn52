...
public class Frame extends JFrame{
	...
	public Frame(int width, int height, ArrayList<Dessin> dessins) {
        ...
        JButton transformDessin = new JButton("Appliquer un transformation à un projet.Dessin");
	...
	public void menuForme(int index){
		...
		JLabel transformation = new JLabel("projet.Transformation");
	...
	public void addForme(){
		...
		comboBoxTypeForme.addItem("projet.Ellipse");
		comboBoxTypeForme.addItem("Cercle");
		comboBoxTypeForme.addItem("projet.Trait");
		comboBoxTypeForme.addItem("Carré");
		comboBoxTypeForme.addItem("projet.Rectangle");
		comboBoxTypeForme.addItem("projet.Polygone");

		comboBoxTypeForme.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				if(comboBoxTypeForme.getSelectedItem().toString() == "projet.Ellipse"){
				...
				} else if(comboBoxTypeForme.getSelectedItem().toString() == "projet.Trait"){
				...
				} else if(comboBoxTypeForme.getSelectedItem().toString() == "projet.Rectangle"){
				...
				} else if(comboBoxTypeForme.getSelectedItem().toString() == "projet.Polygone"){
